...
\begin{abstract}[t] %Hier kommt eine Zusammenfassung des Projektes
...
\section{Einleitung}
Wenn der Laderaum eines Lkws voll geladen ist und über eine Landstraße brettert, dann kann es doch schon mal etwas holprig werden. Das ist nicht nur für den Fahrer unangenehm. Es kann auch gefährlich für den LKW und seine Ladung werden.
...
Federung zu weich eingestellt ist kann sie die Last nicht halten. Wenn nur eine Feder eingesetzt wird kann es zu Schwingungen führen.
...
auch ein pneumatischer Aktuator verwendet. Der Aktuator soll störungen entgegenwirken und den Ladebereich auf einer Bestimmten höhe halten.
...
Für die maximal zu erreichende Höhe ergibt sich:
...
Ich habe eine weitaus größer Abtastrate gewählt als mein Kommilitone Eric Kern. Dies hatte zur Folge, dass mein System ganz anders reagiert hat als das seine.
...
Als mögliche Lösung könnte mithilfe der eines Sensors im Hydraulik Aggregat die gesamt Kraft gemessen werden. 
Daraus könnte dann die momentane Masse des Systems erfasst werden. So könnte der Regler dynamisch auf die Masse reagieren.


Letztentlich ist noch zu sagen, dass der LKW Fahrer wahrscheinlich gar kein Bedienfeld haben will, auf dem er die Höhe der Ladefläche eingeben kann.
