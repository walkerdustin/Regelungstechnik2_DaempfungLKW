	...
	\end{equation}
	\begin{equation}
		\omega_{0} = 2 \pi \cdot f = \frac{2 \pi}{T} = \frac{2 \pi}{\SI{0,964}{s}}  = \SI{6,52}{\frac{1}{s}}
	\end{equation}
	...
	und eine Kraft von $F = \SI{500}{kN}$. Damit ist das Stellglied auf eine Maximalkraft von 
	\begin{equation}
		F_{s, max} = 4 \cdot \SI{500}{kN} = \SI{2000}{kN}
	\end{equation}
