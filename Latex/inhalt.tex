	...
	Auch sollte erwähnt werden, dass die eingestellten Parameter des "Simulink-Solver" für eine solch schnelle Regelung ungeeignet sind.
	...
	Um den Anti-windup Effekt zu verhindern wird im PID-Regler die "Anti-windup Methode" "clamping" aktiviert.
